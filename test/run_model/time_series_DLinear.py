...
from catchMinor.time_series_model.DLinear.lit_DLinear import LitDLinear
...
if __name__ == "__main__":
    ...
    # config
    model_config = DLinear_config(seq_len=128)
    loss_config = DLinear_loss_func_config(optimizer_params={"lr": 0.001})
    optim_config = DLinear_optimizer_config()

    model = LitDLinear(model_config, optim_config, loss_config)
